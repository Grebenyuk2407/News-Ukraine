package dev.androidbroadcast.newsukraine.ui
...
import dev.androidbroadcast.newsukraine.repository.NewsRepository
...
class NewsViewModel(app: Application, val newsRepository: NewsRepository): AndroidViewModel(app) {
    ...
    fun getHeadlines(countryCode: String) = viewModelScope.launch {
        Log.d("NewsViewModel", "Fetching headlines for country code: $countryCode")
    ...
    private fun handleHeadlinesResponse(response: Response<NewsResponce>):Resource<NewsResponce>{
